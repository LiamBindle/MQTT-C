...
Declares all the M\+Q\+T\+T-\/C functions and datastructures.  
...
\begin{center}
\leavevmode
\includegraphics[width=158pt]{mqtt_8h__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=238pt]{mqtt_8h__dep__incl}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em A macro used to declare the enum M\+Q\+T\+T\+Errors and associated error messages (the members of the num) at the same time. \end{DoxyCompactList}\item 
\#define \hyperlink{mqtt_8h_aed8760364c7992625d06c93d12b2496d}{G\+E\+N\+E\+R\+A\+T\+E\+\_\+\+E\+N\+UM}(E\+N\+UM)~E\+N\+UM,
\begin{DoxyCompactList}\small\item\em A macro used to generate the enum M\+Q\+T\+T\+Errors from \hyperlink{mqtt_8h_a86c09e2666bd14722fa165ed904f78cb}{\+\_\+\+\_\+\+A\+L\+L\+\_\+\+M\+Q\+T\+T\+\_\+\+E\+R\+R\+O\+RS}. \end{DoxyCompactList}\item 
\#define \hyperlink{mqtt_8h_adf58d994c35f18ec84b628d8321f52e5}{G\+E\+N\+E\+R\+A\+T\+E\+\_\+\+S\+T\+R\+I\+NG}(S\+T\+R\+I\+NG)~\#S\+T\+R\+I\+NG,
\begin{DoxyCompactList}\small\item\em A macro used to generate the error messages associated with M\+Q\+T\+T\+Errors from \hyperlink{mqtt_8h_a86c09e2666bd14722fa165ed904f78cb}{\+\_\+\+\_\+\+A\+L\+L\+\_\+\+M\+Q\+T\+T\+\_\+\+E\+R\+R\+O\+RS}. \end{DoxyCompactList}\item 
...
\#define \hyperlink{group__details_ga4be078d9d0bd6183b9082f3217622223}{mqtt\+\_\+mq\+\_\+length}(mq\+\_\+ptr)~(((struct \hyperlink{structmqtt__queued__message}{mqtt\+\_\+queued\+\_\+message}$\ast$) ((mq\+\_\+ptr)-\/$>$mem\+\_\+end)) -\/ (mq\+\_\+ptr)-\/$>$queue\+\_\+tail)
...
\#define \hyperlink{group__details_ga8cd873da2116975ce39b313f93068d83}{mqtt\+\_\+mq\+\_\+currsz}(mq\+\_\+ptr)~(mq\+\_\+ptr-\/$>$curr $>$= (uint8\+\_\+t$\ast$) ((mq\+\_\+ptr)-\/$>$queue\+\_\+tail -\/ 1)) ? 0 \+: ((uint8\+\_\+t$\ast$) ((mq\+\_\+ptr)-\/$>$queue\+\_\+tail -\/ 1)) -\/ (mq\+\_\+ptr)-\/$>$curr
...
\begin{DoxyCompactList}\small\item\em Serialize a D\+I\+S\+C\+O\+N\+N\+E\+CT and put it into {\ttfamily buf}. \end{DoxyCompactList}\item 
...
enum \hyperlink{group__api_gad0c901a8d30691ed0ca17915b691b7e7}{M\+Q\+T\+T\+Errors} \hyperlink{group__api_gae3d3aafc7588ed53a90c9f66fc620a6e}{mqtt\+\_\+sync} (struct \hyperlink{structmqtt__client}{mqtt\+\_\+client} $\ast$client)
\begin{DoxyCompactList}\small\item\em Function that does the actual sending and receiving of traffic from the network.

All the other functions in the \hyperlink{group__api}{A\+PI} simply stage messages for being sent to the broker. This function does the actual sending of those messages. Additionally this function receives traffic (responses and acknowledgements) from the broker and responds to that traffic accordingly. Lastly this function also calls the {\ttfamily publish\+\_\+response\+\_\+callback} when any {\ttfamily M\+Q\+T\+T\+\_\+\+C\+O\+N\+T\+R\+O\+L\+\_\+\+P\+U\+B\+L\+I\+SH} messages are received. \end{DoxyCompactList}\item 
...
enum \hyperlink{group__api_gad0c901a8d30691ed0ca17915b691b7e7}{M\+Q\+T\+T\+Errors} \hyperlink{mqtt_8h_a444875d32fd56990f7c5a8251159d6bf}{\+\_\+\+\_\+mqtt\+\_\+ping} (struct \hyperlink{structmqtt__client}{mqtt\+\_\+client} $\ast$client)
...
\begin{DoxyNote}{Note}
You should {\ttfamily \#include $<$\hyperlink{mqtt_8h}{mqtt.\+h}$>$}. 
\end{DoxyNote}
...
MQTT\_ERROR(MQTT\_ERROR\_NULLPTR)                       \(\backslash\)
    ...
    MQTT\_ERROR(MQTT\_ERROR\_CLIENT\_NOT\_CONNECTED)          \(\backslash\)
    MQTT\_ERROR(MQTT\_ERROR\_SEND\_BUFFER\_IS\_FULL)           \(\backslash\)
    MQTT\_ERROR(MQTT\_ERROR\_SOCKET\_ERROR)                  \(\backslash\)
    MQTT\_ERROR(MQTT\_ERROR\_MALFORMED\_REQUEST)             \(\backslash\)
    MQTT\_ERROR(MQTT\_ERROR\_RECV\_BUFFER\_TOO\_SMALL)         \(\backslash\)
    MQTT\_ERROR(MQTT\_ERROR\_ACK\_OF\_UNKNOWN)                \(\backslash\)
    MQTT\_ERROR(MQTT\_ERROR\_NOT\_IMPLEMENTED)               \(\backslash\)
    MQTT\_ERROR(MQTT\_ERROR\_CONNECTION\_REFUSED)            \(\backslash\)
    MQTT\_ERROR(MQTT\_ERROR\_SUBSCRIBE\_FAILED)              \(\backslash\)
    MQTT\_ERROR(MQTT\_ERROR\_CONNECTION\_CLOSED)             \(\backslash\)
\end{DoxyCode}


A macro used to declare the enum M\+Q\+T\+T\+Errors and associated error messages (the members of the num) at the same time. 
...
A macro used to generate the enum M\+Q\+T\+T\+Errors from \hyperlink{mqtt_8h_a86c09e2666bd14722fa165ed904f78cb}{\+\_\+\+\_\+\+A\+L\+L\+\_\+\+M\+Q\+T\+T\+\_\+\+E\+R\+R\+O\+RS}. 
...
A macro used to generate the error messages associated with M\+Q\+T\+T\+Errors from \hyperlink{mqtt_8h_a86c09e2666bd14722fa165ed904f78cb}{\+\_\+\+\_\+\+A\+L\+L\+\_\+\+M\+Q\+T\+T\+\_\+\+E\+R\+R\+O\+RS}. 
...
strlen(str) + 2 
\end{DoxyReturn}
\index{mqtt.\+h@{mqtt.\+h}!\+\_\+\+\_\+mqtt\+\_\+ping@{\+\_\+\+\_\+mqtt\+\_\+ping}}
\index{\+\_\+\+\_\+mqtt\+\_\+ping@{\+\_\+\+\_\+mqtt\+\_\+ping}!mqtt.\+h@{mqtt.\+h}}
\subsubsection[{\texorpdfstring{\+\_\+\+\_\+mqtt\+\_\+ping(struct mqtt\+\_\+client $\ast$client)}{__mqtt_ping(struct mqtt_client *client)}}]{\setlength{\rightskip}{0pt plus 5cm}enum {\bf M\+Q\+T\+T\+Errors} \+\_\+\+\_\+mqtt\+\_\+ping (
\begin{DoxyParamCaption}
\item[{struct {\bf mqtt\+\_\+client} $\ast$}]{client}
\end{DoxyParamCaption}
)}\hypertarget{mqtt_8h_a444875d32fd56990f7c5a8251159d6bf}{}\label{mqtt_8h_a444875d32fd56990f7c5a8251159d6bf}


Ping the broker without locking/unlocking the mutex. 

\begin{DoxySeeAlso}{See also}
\hyperlink{group__api_gae472795684a1d973bfb89d075d17a29e}{mqtt\+\_\+ping} 
\end{DoxySeeAlso}
