...
\subsubsection[{\texorpdfstring{mqtt\+\_\+connect(struct mqtt\+\_\+client $\ast$client, const char $\ast$client\+\_\+id, const char $\ast$will\+\_\+topic, const void $\ast$will\+\_\+message, size\+\_\+t will\+\_\+message\+\_\+size, const char $\ast$user\+\_\+name, const char $\ast$password, uint8\+\_\+t connect\+\_\+flags, uint16\+\_\+t keep\+\_\+alive)}{mqtt_connect(struct mqtt_client *client, const char *client_id, const char *will_topic, const void *will_message, size_t will_message_size, const char *user_name, const char *password, uint8_t connect_flags, uint16_t keep_alive)}}]{\setlength{\rightskip}{0pt plus 5cm}enum {\bf M\+Q\+T\+T\+Errors} mqtt\+\_\+connect (
...
)}\hypertarget{group__api_gadbe914e5a9d4f93314c4e7637cb4f7b3}{}\label{group__api_gadbe914e5a9d4f93314c4e7637cb4f7b3}
...
\begin{Desc}
\item[Examples\+: ]\par
\hyperlink{simple_publisher_8c-example}{simple\+\_\+publisher.\+c}.\end{Desc}
...
\index{A\+PI@{A\+PI}!mqtt\+\_\+sync@{mqtt\+\_\+sync}}
\index{mqtt\+\_\+sync@{mqtt\+\_\+sync}!A\+PI@{A\+PI}}
\subsubsection[{\texorpdfstring{mqtt\+\_\+sync(struct mqtt\+\_\+client $\ast$client)}{mqtt_sync(struct mqtt_client *client)}}]{\setlength{\rightskip}{0pt plus 5cm}enum {\bf M\+Q\+T\+T\+Errors} mqtt\+\_\+sync (
\begin{DoxyParamCaption}
\item[{struct {\bf mqtt\+\_\+client} $\ast$}]{client}
\end{DoxyParamCaption}
)}\hypertarget{group__api_gae3d3aafc7588ed53a90c9f66fc620a6e}{}\label{group__api_gae3d3aafc7588ed53a90c9f66fc620a6e}
...
It is the responsibility of the application programmer to call this function periodically. All functions in the \hyperlink{group__api}{A\+PI} are thread-\/safe so it is perfectly reasonable to have a thread dedicated to calling this function every 200 ms or so. M\+Q\+T\+T-\/C can be used in single threaded application though by simply calling this functino periodically inside your main thread. See \hyperlink{simple_publisher_8c-example}{simple\+\_\+publisher.\+c} and \hyperlink{simple_subscriber_8c-example}{simple\+\_\+subscriber.\+c} for examples (specifically the {\ttfamily client\+\_\+refresher} functions).
\end{DoxyAttention}
\begin{DoxyReturn}{Returns}
